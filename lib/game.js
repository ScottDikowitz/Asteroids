(function () {
  ...
  Asteroids.Game.prototype.draw = function (ctx) {
    ...
    // debugger;
    ctx.font="20px Arial";
    ctx.fillText("Level: " + this.level,350,20);
    ctx.fillText("Asteroids remaining: " + this.asteroids.length,30,20);
    ctx.fillText("Score: " + this.score,650,20);
    ctx.fillText("Lives:  " + this.lives, 650,50);
    ctx.fillText("Fire speed:  " + this.ship.fireSpeed, 650,80);
    ctx.fillText("Accuracy:  " + this.ship.accuracy(), 650,110);
  ...
  Asteroids.Game.prototype.checkScore = function(){
    this.score += 10;
    this.scoreWindow += 10;
    if (this.scoreWindow >= 100 && this.ship.fireSpeed !== 6){
    ...
    if (this.asteroids.length === 0){
      ...
      function(){
        this.powerups.push(
          ...
          pos: [(DIM_X * Math.random()), (DIM_Y * Math.random())],
          game: this
